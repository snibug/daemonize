...
class Daemonize(object):
  ...
  def start(self):
    ...
    # Create a lockfile so that only one instance of this daemon is running at
    # any time.
    try:
    ...
    if self.logger is None:
      ...
      # We will continue with syslog initialization only if actually have such
      # capabilities on the machine we are running this.
    ...
    # daemon. 027 is an octal number which we are typing as 0o27 for Python3
    # compatibility.
    os.umask(0o27)
